    ...
    <div className="max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 flex flex-col md:flex-row items-center gap-6">
      <div className="flex-1 min-w-0">
        <div className="mb-4 md:mb-8">
          <h2 className="text-3xl md:text-4xl xl:leading-[52px] xl:text-5xl mb-2 lg:mb-4 font-bold text-center sm:text-left">
          ...
          <div className="text-base md:text-lg text-gray-400 text-center sm:text-left">
            <p>
              ...
              <span className="text-primary">
                free, self-training and mutual learning
              </span>
              community,
            </p>
            <p>
              aimed at refining their ideas, enhancing their product design and
              UI design skills
            </p>
          </div>
        </div>
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <Button className="w-auto rounded flex items-center justify-center active:scale-95 transition-transform transition-color whitespace-nowrap">
